...
userPref = None
if os.path.exists(os.path.join(libPath, 'user', '%s.py' % user)):
    userPref = pFile.readPyFile(os.path.join(libPath, 'user', '%s.py' % user))
rootDisk = userPref['rootDisk']
binPath = userPref['binPath']
